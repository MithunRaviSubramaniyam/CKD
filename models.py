...
class Model:
    ...
    def svm_classifier(self):
        ...
        print(f"SVM Classifier 10-fold cross-validation accuracy: {scores.mean() * 100} %")
    ...
    def decisionTree_classifier(self):
        ...
        scores = cross_val_score(classifier, self.x_train, self.y_train, cv=10)
        print(f"Decision Tree Classifier 10-fold cross-validation accuracy: {scores.mean() * 100} %")
        return classifier.fit(self.x_train, self.y_train)
    ...
    def randomforest_classifier(self):
        ...
        scores = cross_val_score(classifier, self.x_train, self.y_train, cv=10)
        print(f"Random Forest Classifier 10-fold cross-validation accuracy: {scores.mean() * 100} %")
        return classifier.fit(self.x_train, self.y_train)
    ...
    def naiveBayes_classifier(self):
        ...
        scores = cross_val_score(classifier, self.x_train, self.y_train, cv=10)
        print(f"Naive Bayes Classifier 10-fold cross-validation accuracy: {scores.mean() * 100} %")
        return classifier.fit(self.x_train, self.y_train)
    ...
    def knn_classifier(self):
        ...
        scores = cross_val_score(classifier, self.x_train, self.y_train, cv=10)
        print(f"KNN Classifier 10-fold cross-validation accuracy: {scores.mean() * 100} %")
        return classifier.fit(self.x_train, self.y_train)
